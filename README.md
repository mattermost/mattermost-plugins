...
To add your plugin as an unofficial plugin to this repository `git submodule add https://github.com/mattermost/mattermost-plugin-profanity-filter.git Unofficial/mattermost-plugin-profanity-filter`. The process to get your plugin to production level is not yet determined.
